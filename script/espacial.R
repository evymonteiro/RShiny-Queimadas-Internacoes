...
##Banco de dados 1: Focos de Queimadas - Coordenadas geográficas associadas
##Banco de dados 2: Dados de CID respiratórios do DATASUS - Cidade + UF 
...
#devtools::install_github("rfsaldanha/read.dbc")
#remotes::install_github("rfsaldanha/microdatasus")


#Banco de dados Terrabrasilis: Coluna Estado - Nomes das UF. 
#Banco de dados SUS: Coluna UF_ZI, Coluna MUNIC_RES e Coluna QT_DIARIAS

##Utilizar um contador para casos por UF e dados anuais. 
...
load("POPULACAO.RData") ##### População Estimada 2024 IBGE

#save(POPULACAO, file = "POPULACAO.RData")

# Lendo os dados extraidos do TerraBrasilis
load("DadosBR.RData")   ##Todos os dados
load("dadosBR_mes.RData")  ##Dados com as transformações feitas abaixo.
load("dados_biomas.RData") ## Dados sem o recorte de anos. 

### LOAD BANCO DE DADOS DATASUS ###

load("dados_sih.RData")
load("sih_mes.RData") ##Dados com as transformações feitas abaixo.
...
dadosBR_mes <- dadosBR %>%
  ...
  count(Estado, Mes, name = "QtdFocos")
